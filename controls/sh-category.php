...
if ($result->num_rows > 0) {
  echo '
    <div class="cont">
    <p class="title">عرض و تعديل و حذف التصنيفات</p>
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    <tr>
    <td>
      <span><a href="edit-category.php?' . $row["CatID"] . '"><i class="fa fa-cog"></a></i></span>
      <span><a href="delete-category.php?' . $row["CatID"] . '"><i class="fa fa-trash"></i></a></span>
    </td>
    <td> ' . $row['CatID'] . '</td>
    <td>' . $row['CatName'] . '</td>
    <td>' . $row['CatName2'] . '</td>
