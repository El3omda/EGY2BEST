...
$sql = "SELECT * FROM movies WHERE CatName = 'animation'";

$result = mysqli_query($conn, $sql);

$sql1 = "SELECT * FROM series WHERE CatName = 'animation'";
...
<body>
  ...
  <div class="box">
    ...
    <p class="name"><a href="movie-page.php?' . $generateLink . '">' . $row['MovieName1'] . '</a></p>
    <div class="box-info">
      <ul>
  ...
  ';
    ...
    while ($row1 = $result1->fetch_assoc()) {
      // Generate Main Page
      $mainPage = $row1['SeriesName1'];
      $generateLink = str_replace(" ", "-", $mainPage);
      echo '
  <div class="box">
    <div class="cover">
      <img src="' . $row1['SeriesCover'] . '" alt="">
    </div>
    <p class="name"><a href="series-page.php?' . $generateLink . '">' . $row1['SeriesName1'] . '</a></p>
    <div class="box-info">
      <ul>
        <li><i class="fa fa-imdb"></i>' . $row1['IMDBRate'] . '</li>
        <li><i class="fa fa-clock-o"></i>' . $row1['SeriesLength'] . ' Min</li>
      </ul>
    </div>
    <div class="video-year">' . $row1['VedioQuality'] . '  ' . $row1['SeriesYear'] .  ' </div>
  </div>
  ';
    }
